...
const UserCard: React.FC<ComponentPropsType> = ({
  ...
  return (
    <>
      <div
        className={`w-md h-32 bg-white border border-gray-200 border-l-6 rounded-xl shadow-sm px-6 py-2 ${statusColor[status]} `}
      >
          ...
          <div className="flex-1">
            <div className="flex flex-col items-start justify-between mb-4">
              <Tooltip content={name}>
                <h1 className="text-3xl font-bold text-gray-900 pb-2 mb-2 overflow-x-hidden whitespace-nowrap text-ellipsis w-sm">
                  {name}
                </h1>
              </Tooltip>
